...
# Use `or` so empty-string env vars (sbatch's `-e VAR="${VAR:-}"`) fall back.
fast_cell = os.environ.get("FAST_CELL") or fast_cell
slow_cell = os.environ.get("SLOW_CELL") or slow_cell
